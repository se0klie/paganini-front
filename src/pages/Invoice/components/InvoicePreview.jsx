...
import { Box, Typography, Grid, Divider, Card, CardContent, 
         Table, TableBody, TableCell, TableContainer, TableHead, 
         TableRow, Chip } from '@mui/material';
                                        ...
                                        <TableRow key={index} sx={{
                                            ...
                                            <TableCell align="right">
                                                <Box sx={{ 
                                                    ...
                                                    <Typography component="span" sx={{ color: 'var(--color-text-muted)', fontSize: '0.85rem' }}>
                    ...
                    <Box sx={{ 
                        ...
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={5} sx={{ textAlign: 'right' }}>
                                <Typography sx={{ color: 'var(--color-text-secondary)' }}>
                                    {currencySymbols[currency]}{totals.subtotal}
                                </Typography>
                            </Grid>
                            <Grid item xs={7}>
                                <Typography sx={{ color: 'var(--color-text-secondary)' }}>IVA (15%):</Typography>
                            </Grid>
                            <Grid item xs={5} sx={{ textAlign: 'right' }}>
                                <Typography sx={{ color: 'var(--color-text-secondary)' }}>
                                    {currencySymbols[currency]}{totals.tax}
                                </Typography>
                            </Grid>
                            <Grid item xs={12}><Divider sx={{ my: 1 }} /></Grid>
                            <Grid item xs={7}>
                                <Typography sx={{ color: 'var(--color-primary)', fontWeight: 700 }}>Total:</Typography>
                            </Grid>
                            <Grid item xs={5} sx={{ textAlign: 'right' }}>
                                <Typography sx={{ color: 'var(--color-primary)', fontWeight: 700 }}>
                                    {currencySymbols[currency]}{totals.total}
                                </Typography>
                            </Grid>
                            {installments && (
                                <>
                                    <Grid item xs={12}><Divider sx={{ my: 1 }} /></Grid>
                                    <Grid item xs={7}>
                                        <Typography sx={{ color: 'var(--secondary-accent)', fontWeight: 600 }}>
