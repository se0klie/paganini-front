...
const availableProducts = [
    { id: 1, name: 'Producto Premium', price: { USD: 299.99, EUR: 275.5, MXN: 5999.99 } },
    { id: 2, name: 'Servicio Básico', price: { USD: 99.99, EUR: 92.5, MXN: 1999.99 } },
    { id: 3, name: 'Producto Estándar', price: { USD: 149.99, EUR: 138.5, MXN: 2999.99 } },
    { id: 4, name: 'Servicio Premium', price: { USD: 399.99, EUR: 368.5, MXN: 7999.99 } },
];
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">
                                            {quantity > 0 && (
                                                ...
                                                >
                                                    {currencySymbols[currency]}
                                                    {(product.price[currency] * quantity).toFixed(
                                                        2
                                                    )}
                                                </Typography>
                                            )}
